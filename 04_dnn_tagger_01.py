...
def build_graph(seq_len, input_dim, output_dim, embedding_dim, learning_rate):
    ...
    return x, y, optimizer, loss, pred_argmax, W, b
...
def main():
    ...
    x, y, optimizer, loss, pred_argmax, W, b = build_graph(seq_len, input_dim, output_dim, embedding_dim, learning_rate)
